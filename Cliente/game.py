...
# Mensaje Bienvenido
mensajeBienvenida = fuente2.render('Bienvenido a TelePong! ', True, pygame.Color('green'))
...
# Botón "Play"
boton = pygame.Rect(anchoOriginal // 4, altoOriginal * 3 / 4, anchoOriginal // 2, 50)
        ...
        if not transporte.cola_de_mensajes.empty():
            ...
            if len(partes) == 6:
                ...
                if puntaje_jugador1 == 3:
                    mensaje_ganador = fuente.render("Jugador 1 ganó!", True, white)
                    ...
                    pygame.quit()
                    sys.exit()
                elif puntaje_jugador2 == 3:
                    mensaje_ganador = fuente.render("Jugador 2 ganó!", True, white)
                    mensaje_ganador_rect = mensaje_ganador.get_rect(
                    center=(anchoOriginal // 2, altoOriginal // 2))
                    pantalla.blit(mensaje_ganador, mensaje_ganador_rect)
                    pygame.display.flip()
